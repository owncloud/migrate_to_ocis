...
class UserGroupFinder {
	...
	/**
	 * map ownCloud Classic username -> ocis user id
	 * @var array<string, string>
	 */
	private array $userCache = [];
	/**
	 * map ownCloud Classic group displayname -> ocis group id.
	 ...
	 * @param IUserManager $userManager get ownCloud Classic users by id if needed
	 * @param IGroupManager $groupManager get ownCloud Classic groups by id if needed
	 */
	...
	/**
	 * Get the oCIS user id that matches the ownCloud Classic user. If the user isn't
	 ...
	 * @param IUser $user the ownCloud Classic user
	...
	/**
	 * Get the oCIS group id that matches the ownCloud Classic group. If the group isn't
	 ...
	 * @param string $token oCIS admin's app password to make the
	 * request to oCIS if needed
	 * @param IGroup $group the ownCloud Classic group
	...
	/**
	 * Same as "getUser" but we use the ownCloud Classic user id instead.
	 * The ownCloud Classic user manager will be used to find the user that will
	 * be matched.
	 *
	 * @param string $token oCIS admin's app password to make the
	 * request to oCIS if needed
	...
	/**
	 * Same as "getGroup" but we use the ownCloud Classic group id instead.
	 * The ownCloud Classic group manager will be used to find the group that will
	 * be matched.
	 *
	 * @param string $token oCIS admin's app password to make the
	 * request to oCIS if needed
