...
class MigrateGroups extends CommandMigration {
	...
	protected function configure() {
		$this
			->setName('migrate:to-ocis:migrate:groups')
			->setDescription('Migrates ownCloud groups to the configured ocis instance. See also: https://doc.owncloud.com/server/latest/admin_manual/maintenance/migrating_to_ocis.html')
	...
	protected function verifyState(State $state, array &$params): ?string {
		if (\get_class($state) !== StateMigrateGroups::class) {
